unless @invoice.nro.nil?
  2.times do
    ...
    pdf.text_box @factura_header, :width => 300, :at => [100,pdf.bounds.top-148]
    pdf.text_box "Cliente Nº "+@invoice.client.id.to_s, :width => 130, :at => [450,pdf.bounds.top-148]
    pdf.draw_text @invoice.condicion_iva, :at => [70,pdf.bounds.top-191]
    pdf.draw_text @invoice.client.cuit, :at => [350,pdf.bounds.top-191]

    pdf.bounding_box [10,pdf.bounds.top-257], :width => 560 do
      pdf.table @products,
          :font_size  => 9, 
...
unless @invoice.remito_nro.nil?
  3.times do
    ...
    pdf.draw_text "BS.AS. #{@invoice.date.strftime('%d/%m/%y')}", :at => [410,pdf.bounds.top-80]
    pdf.text_box @remito_header, :width => 300, :at => [100,pdf.bounds.top-148]
    pdf.text_box "Cliente Nº "+@invoice.client.id.to_s, :width => 130, :at => [450,pdf.bounds.top-148]
    pdf.draw_text @invoice.condicion_iva, :at => [70,pdf.bounds.top-191]
    pdf.draw_text @invoice.client.cuit, :at => [350,pdf.bounds.top-191]
